...
const test = async () => {
    ...
    const channel = chatClient.channel('messaging', 'Taylor', {});
    ...
    const M1 = {
        text: "Hey Jen, Have you had a chance to review the QBRs yet? If so, can you please book a time to meet next week?", 
        user_id: userID1
    }
    const M2 = {
