...
export declare type EnrichedActivity<UserType extends UR = UR, ActivityType extends UR = UR, CollectionType extends UR = UR, ReactionType extends UR = UR, ChildReactionType extends UR = UR> = Activity<ActivityType> & {
