...
var ChannelState = /*#__PURE__*/function () {
  ...
  _createClass__default['default'](ChannelState, [{
    ...
    value: function _addToMessageList(messages, message) {
      ...
      var messageTime = message.created_at.getTime(); // if message is newer than last item in the list concat and return

      if (messageArr[messageArr.length - 1].created_at.getTime() < messageTime) return messageArr.concat(message); // find the closest index to push the new message
      ...
      while (left <= right) {
        ...
        if (messageArr[middle].created_at.getTime() <= messageTime) left = middle + 1;else right = middle - 1;
    ...
    value: function removeMessage(messageToRemove) {
      ...
      if (messageToRemove.parent_id && this.threads[messageToRemove.parent_id]) {
        var _this$removeMessageFr = this.removeMessageFromArray(this.threads[messageToRemove.parent_id], messageToRemove),
            ...
            threadMessages = _this$removeMessageFr.result; // @ts-expect-error - ImmutableArray.set exists in the documentation but not in the DefinitelyTyped types
...
var Channel = /*#__PURE__*/function () {
  ...
  _createClass__default['default'](Channel, [{
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                if (this.id) {
                  id = this.id;
                } else if (((_this$data = this.data) === null || _this$data === void 0 ? void 0 : _this$data.members) && Array.isArray(this.data.members)) {
        ...
        return _regeneratorRuntime__default['default'].wrap(function _callee22$(_context22) {
          while (1) {
            switch (_context22.prev = _context22.next) {
              case 0:
                if ((_this$getConfig = this.getConfig()) === null || _this$getConfig === void 0 ? void 0 : _this$getConfig.typing_events) {
                  _context22.next = 2;
                  break;
                }
        ...
        return _regeneratorRuntime__default['default'].wrap(function _callee23$(_context23) {
          while (1) {
            switch (_context23.prev = _context23.next) {
              case 0:
                if ((_this$getConfig2 = this.getConfig()) === null || _this$getConfig2 === void 0 ? void 0 : _this$getConfig2.typing_events) {
                  _context23.next = 2;
                  break;
                }
          ...
          while (1) {
            switch (_context24.prev = _context24.next) {
              case 0:
                ...
                if ((_this$getConfig3 = this.getConfig()) === null || _this$getConfig3 === void 0 ? void 0 : _this$getConfig3.read_events) {
                  _context24.next = 4;
                  break;
                }
    ...
    value: function _countMessageAsUnread(message) {
      ...
      if (((_message$user2 = message.user) === null || _message$user2 === void 0 ? void 0 : _message$user2.id) && this.getClient().userMuteStatus(message.user.id)) return false;
      return true;
    }
    /**
    ...
    value: function countUnreadMentions() {
      ...
      for (var i = 0; i < this.state.messages.length; i += 1) {
        ...
        if (this._countMessageAsUnread(message) && (!lastRead || message.created_at > lastRead) && ((_message$mentioned_us = message.mentioned_users) === null || _message$mentioned_us === void 0 ? void 0 : _message$mentioned_us.find(function (u) {
          return u.id === userID;
        }))) {
          count++;
        }
    ...
    value: function _handleChannelEvent(event) {
      ...
      switch (event.type) {
        case 'typing.start':
          if ((_event$user = event.user) === null || _event$user === void 0 ? void 0 : _event$user.id) {
        ...
        case 'typing.stop':
          if ((_event$user2 = event.user) === null || _event$user2 === void 0 ? void 0 : _event$user2.id) {
        ...
        case 'message.read':
          if ((_event$user3 = event.user) === null || _event$user3 === void 0 ? void 0 : _event$user3.id) {
        ...
        case 'user.updated':
          if ((_event$user5 = event.user) === null || _event$user5 === void 0 ? void 0 : _event$user5.id) {
        ...
        case 'user.watching.stop':
          if ((_event$user6 = event.user) === null || _event$user6 === void 0 ? void 0 : _event$user6.id) {
        ...
        case 'message.new':
          if (event.message) {
            ...
            if (ownMessage && ((_event$user8 = event.user) === null || _event$user8 === void 0 ? void 0 : _event$user8.id)) {
              s.unreadCount = 0;
              s.read = s.read.set(event.user.id, Immutable__default['default']({
                user: _objectSpread$2({}, event.user),
        ...
        case 'member.added':
        case 'member.updated':
          if ((_event$member = event.member) === null || _event$member === void 0 ? void 0 : _event$member.user_id) {
            var _event$member2;
        ...
        case 'member.removed':
          if ((_event$user9 = event.user) === null || _event$user9 === void 0 ? void 0 : _event$user9.id) {
      ...
      var _updateAppSettings = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee3(options) {
        ...
        return _regeneratorRuntime__default['default'].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if ((_options$apn_config = options.apn_config) === null || _options$apn_config === void 0 ? void 0 : _options$apn_config.p12_cert) {
    ...
    */
    ...
    value: function disconnect(timeout) {
      ...
      for (var _i2 = 0, _Object$values = Object.values(this.activeChannels); _i2 < _Object$values.length; _i2++) {
        var _channel = _Object$values[_i2];
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 11:
                ...
                _response$user = response.user, created_at = _response$user.created_at, updated_at = _response$user.updated_at, last_active = _response$user.last_active, online = _response$user.online, guestUser = _objectWithoutProperties__default['default'](_response$user, ["created_at", "updated_at", "last_active", "online"]);
                _context7.next = 15;
    ...
    value: function _handleClientEvent(event) {
      ...
      if (event.type === 'notification.channel_mutes_updated' && ((_event$me = event.me) === null || _event$me === void 0 ? void 0 : _event$me.channel_mutes)) {
        this.mutedChannels = event.me.channel_mutes;
      }

      if (event.type === 'notification.mutes_updated' && ((_event$me2 = event.me) === null || _event$me2 === void 0 ? void 0 : _event$me2.mutes)) {
    ...
    */
    ...
    value: function channel(channelType, channelIDOrCustom) {
      ...
      if (_typeof__default['default'](channelIDOrCustom) === 'object') {
        return new Channel(this, channelType, undefined, channelIDOrCustom);
      }

      if (typeof channelIDOrCustom === 'string' && ~channelIDOrCustom.indexOf(':')) {
        throw Error("Invalid channel id ".concat(channelIDOrCustom, ", can't contain the : character"));
      } // only allow 1 channel object per cid


      var cid = "".concat(channelType, ":").concat(channelIDOrCustom);

      if (cid in this.activeChannels) {
        var _channel2 = this.activeChannels[cid];
      ...
      var channel = new Channel(this, channelType, channelIDOrCustom, custom);
    ...
    value: function getUserAgent() {
      return this.userAgent || "stream-chat-javascript-client-".concat(this.node ? 'node' : 'browser', "-", "2.11.1");
    }
  }, {
    key: "setUserAgent",
    ...
    value: function _startCleaning() {
      ...
      this.cleaningIntervalRef = setInterval(function () {
        ...
        for (var _i4 = 0, _Object$values2 = Object.values(that.activeChannels); _i4 < _Object$values2.length; _i4++) {
          var _channel3 = _Object$values2[_i4];
